...
from use_augument_data.two_dim.lenet5 import lenet5
accuracy_list = {'0HP': [], '1HP': [], '2HP': [], '3HP': []}
time_list = {'0HP': [], '1HP': [], '2HP': [], '3HP': []}



def train_lenet5_DF(path):
    start = time.time()
    ...
    print("layer_train's shape{0}".format(layer_test.shape))
